...
export default function Dashboard() {
  ...
  const getTitle = () => {
    switch (type) {
      case 'skills':
        return 'Show Your Skills Dashboard';
      case 'selling':
        return 'Start Selling Dashboard';
      case 'jobs':
        return 'Find Jobs Dashboard';
      default:
        return 'Welcome back, Vedika 👋';
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 p-6">
      ...
      <header className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-purple-700">{getTitle()}</h1>
