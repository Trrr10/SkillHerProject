        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="space-y-3 flex-1">
              ...
              <NavItem icon={<Award size={20} />} label="Certificates" onClick={() => navigate("/certificates")} />
              <NavItem icon={<MessageSquare size={20} />} label="Community" onClick={() => navigate("/community")} />
              <div className="pt-8">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 mb-4 ml-2">
                  Account & Tools
                </p>
